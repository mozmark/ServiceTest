...
ServiceStub.prototype.hook = function () {
  readURI(this.url).then(function(data) {
    ...
    for(key in commands) {
      ...
      // TODO: this is messy; should just tack the exec onto the object rather
      // than explicitly copying over the properties
      gcli.addCommand({
...
var serviceStub = new ServiceStub('http://localhost:3000/templates/service.json','wscmd');
serviceStub.hook();
